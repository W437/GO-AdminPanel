                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6 lang_form" id="default-form">
                                ...
                                <div class="row g-3">
                                    <div class="col-md-12">
                                        <label for="title" class="form-label">{{translate('messages.title')}} ({{ translate('messages.default') }})
                                        ...
                                        <input id="title" type="text" maxlength="20" name="title[]"   value="{{ $service?->getRawOriginal('title') }}" class="form-control" placeholder="{{translate('Ex:_John')}}">
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input id="sub_title" type="text" maxlength="80" name="sub_title[]"  value="{{ $service?->getRawOriginal('sub_title') }}" class="form-control" placeholder="{{translate('Very_Good_Company')}}">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-none lang_form" id="{{$lang}}-form1">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input  id="title{{$lang}}" type="text" maxlength="20" name="title[]" value="{{ $translate[$lang]['react_service_title']??'' }}" class="form-control" placeholder="{{translate('messages.name_here...')}}">
                                </div>
                                <div class="col-12">
                                    <label for="sub_title{{$lang}}" class="form-label">{{translate('Subtitle')}} ({{strtoupper($lang)}})
                                        ...
                                        <input id="sub_title{{$lang}}"  type="text" maxlength="80" name="sub_title[]"  value="{{ $translate[$lang]['react_service_sub_title']??'' }}"  class="form-control" placeholder="{{translate('Very_Good_Company')}}">
                                    </div>
                            </div>
                        </div>
